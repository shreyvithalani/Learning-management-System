...
goog.require('goog.string.StringBuffer');
clojure.string.seq_reverse = (function seq_reverse(coll){return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.with_meta(cljs.core.List.EMPTY,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$6,"/Users/shreyvithalani/Desktop/lms-gradesheet/target/cljsbuild-compiler-0/clojure/string.cljs"], null)),coll);
});
/**
...
{{
var G__6792 = cljs.core.pop(v__$1);
v__$1 = G__6792;
continue;
}
} else
...
{var pred__6796 = cljs.core._EQ_;var expr__6797 = limit;if(cljs.core.truth_((pred__6796.cljs$core$IFn$_invoke$arity$2 ? pred__6796.cljs$core$IFn$_invoke$arity$2(1,expr__6797) : pred__6796.call(null,1,expr__6797))))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_((pred__6796.cljs$core$IFn$_invoke$arity$2 ? pred__6796.cljs$core$IFn$_invoke$arity$2(2,expr__6797) : pred__6796.call(null,2,expr__6797))))
...
var split__3 = (function (s,re,limit){return clojure.string.discard_trailing_if_needed(limit,((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2([cljs.core.str(re)].join(''),"/(?:)/"))?clojure.string.split_with_empty_regex(s,limit):(((limit < 1))?cljs.core.vec([cljs.core.str(s)].join('').split(re)):(function (){var s__$1 = s;var limit__$1 = limit;var parts = cljs.core.with_meta(cljs.core.PersistentVector.EMPTY,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$6,"/Users/shreyvithalani/Desktop/lms-gradesheet/target/cljsbuild-compiler-0/clojure/string.cljs"], null));while(true){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(limit__$1,1))
{return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1);
} else
{var temp__4423__auto__ = cljs.core.re_find(re,s__$1);if(cljs.core.truth_(temp__4423__auto__))
{var m = temp__4423__auto__;var index = s__$1.indexOf(m);{
var G__6799 = s__$1.substring((index + cljs.core.count(m)));
var G__6800 = (limit__$1 - 1);
var G__6801 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1.substring(0,index));
s__$1 = G__6799;
limit__$1 = G__6800;
parts = G__6801;
continue;
...
{var ch = s.charAt(index);var temp__4423__auto___6803 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cmap,ch);if(cljs.core.truth_(temp__4423__auto___6803))
{var replacement_6804 = temp__4423__auto___6803;buffer.append([cljs.core.str(replacement_6804)].join(''));
} else
{buffer.append(ch);
}
{
